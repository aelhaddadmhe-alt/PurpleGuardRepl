...
export const metadata: Metadata = {
  title: "PurpleSentinel — Managed Detection & Response (MDR / MXDR)",
  description: "Deep visibility and rapid response across endpoints, networks, and cloud. PurpleSentinel delivers MDR with automated containment and threat hunting.",
};
